...
def crop_fr_detector_filterd_20210121(remake=False):
    base_output_dir = '/home/ntanh/ntanh/MC_OCR/data/line_croped_20210121'
    if remake:
        if os.path.exists(base_output_dir):
            shutil.rmtree(base_output_dir)
    data_in = [
        {
            'img_dirs': '/home/ntanh/ntanh/MC_OCR/mc_ocr/rotation_corrector/output_results/text_classifier/train_pred_lines_filtered/imgs',
            'lbl_dirs': '/home/ntanh/ntanh/MC_OCR/mc_ocr/rotation_corrector/output_results/text_classifier/train_pred_lines_filtered/txt',
            'out_dir': 'train_pred_lines_filtered'
        },
    ]
